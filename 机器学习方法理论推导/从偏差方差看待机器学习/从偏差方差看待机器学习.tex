...
\maketitle
    ...
    \begin{align*}
        ...
        =&\mathbb{E}(f(x)-\mathbb{E}(\widehat{f}(x)))^2\\&-2\mathbb{E}[(f(x)-\mathbb{E}\widehat{f}(x))]^2+\mathbb{E}[\widehat{f}(x)-\mathbb{E}\widehat{f}(x)]^2\\
    \end{align*}
    ...
    第二项展开
    \[-2\mathbb{E}[(f(x)-\mathbb{E}\widehat{f}(x))]^2=0\]
