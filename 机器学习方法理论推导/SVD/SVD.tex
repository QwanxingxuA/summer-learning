...
\maketitle
    ...
    \section{SVD}
        ...
        Let 
        \[\boldsymbol{V}_1=[\mu_1\quad\mu_2\quad\cdots\quad\mu_r],\quad\boldsymbol{V}_2=[\mu_{r+1}\quad\cdots\quad\mu_n]\]
        where $\mu_1,\mu_2,\cdots,\mu_r$ are positive eigenvalues' corresponding eigenvectors and $\mu_{r+1},\cdots,\mu_n$ are zero eigenvalues'  corresponding eigenvectors.
